...
let body = JSON.stringify({ nuevo : localStorage.busqueda })
        ...
        if(request.status == 200){
            ...
            user_string += `
                        ...
                        <div class="grid-item grid-h"><p>
                            <a href="resultados.html" onclick="ordenar('/usuario')">Usuario</a>
                        </p></div>
                        <div class="grid-item grid-h"><p>
                            <a href="resultados.html" onclick="ordenar('/resumen')">Resumen</a>
                        </p></div>
                        <div class="grid-item grid-h"><p>
                            <a href="resultados.html" onclick="ordenar('/positivo')">Positivo</a>
                        </p></div>
                        <div class="grid-item grid-h"><p>
                            <a href="resultados.html" onclick="ordenar('/negativo')">Negativo</a>
                        </p></div>
                        <div class="grid-item grid-h"><p>
                            <a href="resultados.html" onclick="ordenar('/puntaje')">Puntaje</a>
                        </p></div>
                    `
            jason.forEach( e => {
                user_string += `
